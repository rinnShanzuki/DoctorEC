...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('product_reservations', function (Blueprint $table) {
            ...
            $table->foreignId('client_id')->after('prodres_id')->constrained('users', 'id')->onDelete('cascade');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('product_reservations', function (Blueprint $table) {
            ...
            $table->foreignId('client_id')->after('prodres_id')->constrained('client_accounts', 'client_id')->onDelete('cascade');
        });
    }
};
